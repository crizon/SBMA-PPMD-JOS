...
<div class="harang HWP" id="harang" hidden="hidden">
	
		<center>
			<div style="position:fixed; bottom:5%; width: 100%">
			<h5>NOTE: This job is completed and will be checked by the supervisor.</h5>
			<a href="index.php" class="HWP">
				<button class="btn btn-success btn-block"> <span class="fa fa-arrow-left "></span> BACK </button>
			<a/>
			<br>
			<button onclick="window.print();" class="btn btn-primary btn-block"> <span class="fa fa-print"></span> PRINT </button>
			</div>
		</center>

		<img src="../img/happy.png" width="10%" style="position: fixed; bottom: 5%">
		
</div>

<div class="harang2 HWP" id="harang2" hidden="hidden">
	
		<center>
			<div style="position:fixed; bottom:5%; width: 100%">
			<h5>NOTE: This job is completed and checked.</h5>
			<a href="index.php" class="HWP">
				<button class="btn btn-success btn-block"> <span class="fa fa-arrow-left "></span> BACK </button>
			<a/>
			<br>
...
<div class="harang3 HWP" id="harang3" hidden="hidden">
	
		<center>
			<div style="position:fixed; bottom:5%; width: 100%">
			<h5>NOTE: This job is cancelled contact your supervisor.</h5>
			<a href="index.php" class="HWP">
				<button class="btn btn-success btn-block"> <span class="fa fa-arrow-left "></span> BACK </button>
			<a/>
			<br>
...
<div class="container"><!-- 
	...
	<form action="new_JO_saver.php" method="POST" id="trupa">
		...
		<script type="text/javascript">
			function totalxzs(){
				...
				if (checkblock=='1') {
					...
					document.getElementById("finalize").setAttribute("hidden", "hidden");
					document.getElementById("iprint").setAttribute("hidden", "hidden");

					document.getElementById("harang").removeAttribute("hidden");
					...
					document.getElementById("harang2").removeAttribute("hidden");
					...
					document.getElementById("harang3").removeAttribute("hidden");
		...
		<button type="submit" name="inprocess" id="submit" onclick="gun1()" class="mybutt bg-warning HWP"> <span class="fa fa-save"></span> Save </button>
