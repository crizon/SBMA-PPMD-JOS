      ...
      <div class="row">
        <div class="col-5" style="padding: 25px">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" name="xPERSONNEL" class="form-control input_user" value="" placeholder="Performed By">
            ...
            <div class="input-group mb-3">
                ...
                <select name="xREQUESTING" class="form-control input_pass">
                  <option> Requesting Dept./Company </option>
                    <?php  foreach($tableX as $dbmaster) { ?>
                        <option value="<?=$dbmaster['customerName']?>">• <?=$dbmaster["customerName"]?> </option>
                    <?php }?>
                </select>
