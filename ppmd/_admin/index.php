...
if(isset($_SESSION['account0'])){
    ...
    $tableX=$db->prepare("SELECT * FROM jo_master WHERE JOB_ORDER_num != 0 ORDER BY jo_master.ID DESC");
    $tableX->execute();
...
<body>
    ...
    <div>
        ...
        <button onclick="window.location='_customer/index.php'" class="HFP btn" style="background-color: #ff4f3b"> <span class="fa fa-ban"></span> X List </button>

        <button style="width: 25px; opacity: 0"></button>

        <button onclick="window.location='_employees/index.php'" class="HFP btn" style="background-color: purple"> <span class="fa fa-user"></span> Employee </button>

        <button style="width: 25px; opacity: 0"></button>

        <button onclick="window.location='_users/index.php'" class="HFP btn" style="background-color: orange"> <span class="fa fa-user"></span> Users </button>
