...
jo_master.ID,
jo_master.JOB_ORDER_num,
jo_master.`STATUS`,
jo_master.SECTION,
jo_master.DATE_STARTED,
jo_master.TIME_STARTED,
jo_master.DATE_COMPLETED,
jo_master.TIME_COMPLETED,
jo_master.LOCATION,
jo_master.REQUESTING_COMPANY_DEPARTMENT,
jo_master.CONTACT_PERSON,
jo_master.NATURE_OF_WORK,
jo_master.PO_CONTRACT,
jo_master.PAR,
jo_master.PAR_QTY,
jo_master.ICS,
jo_master.ICS_QTY,
...
jo_master.ITEMS,
jo_master.CHECKED,
jo_master.RECEIVED_BY,
jo_master.DATE_TIME_RECEIVED,
jo_master.FROM_BLDG,
jo_master.TO_BLDG,
jo_master.REMARKS,
jo_master.EMPLOYEES,
jo_master.EMPLOYEES_2,
jo_master.EMPLOYEES_3,
jo_master.EMPLOYEES_4,
jo_master.EMPLOYEES_5,
jo_master.EMPLOYEES_6
FROM
jo_master
WHERE
jo_master.SECTION = 'INVENTORY'");
...
<body>
    ...
    <br><br>
    <center>
        <h1>JOB ORDER - INVENTORY SECTION</h1>
